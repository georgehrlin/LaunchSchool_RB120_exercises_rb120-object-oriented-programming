=begin
When I read through the faulty code, I noticed that johns_postal_service, which
is a PostalService object, has no access to a send method. send is an instance
method under the Mailing module, but neither the PostalService class nor its
superclass CommunicationsProvider has it mixed in.
=end
...
=begin
CORRECTION
There is a built-in method called Object#send, which is used to invoke methods
dynamically. Therefore, the original error here is a case of accidental method
overriding.
=end
